function Box(props) {
	...
	return (
		<div className={'w-8 h-8 sm:w-10 sm:h-10 grid place-items-center p-0 m-0 font-bold text-lg sm:text-2xl ' + state}>{props.value}</div>
	)
}
...
function Help() {
	return (
		<>
			<p className="py-5 mr-1 text-sm text-left opacity-75 sm:text-base font-regular">
				Guess the WORDLE in six tries.
				<br />
				Each guess must be a valid five-letter word. Hit the enter button to submit.
				<br /> After each guess, the color of the tiles will change to show how close your guess was to the word.
			</p>
			<hr />
			<h3 className="py-5 font-bold text-left">Examples</h3>
