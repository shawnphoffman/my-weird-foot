...
export default async function PostComments({ url }: Props) {
	...
	return (
		<div className="flex flex-col items-center justify-center w-full max-w-screen-md gap-2 p-4 text-left rounded-lg bg-black-950/50">
			{/* STATS */}
			<h2 className="text-2xl font-bold text-center text-hp3" id="comments-section">
				Stats
			</h2>
			...
			{!thread.replies || thread.replies.length === 0 ? null : (
				<>
					{/* COMMENTS */}
					<h2 className="text-2xl font-bold text-center text-hp3">Comments</h2>
					<p className="text-sm">
