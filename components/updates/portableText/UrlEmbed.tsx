...
export default function UrlEmbedLoader({ url }: Props) {
	return (
		<Link
			href={url}
			target="_blank"
			className="flex flex-col justify-center gap-4 my-2 overflow-hidden transition-colors border border-transparent rounded-lg hover:border-hp2 group embed bg-zinc-950/75"
		>
